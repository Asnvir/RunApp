...
import com.example.runapp.databinding.FragmentStatisticsBinding
import com.example.runapp.other.CustomMarkerView
import com.example.runapp.other.TrackingUtility
import com.example.runapp.ui.viewmodels.MainViewModel
import com.example.runapp.ui.viewmodels.StatisticsViewModel
...
class StatisticsFragment : Fragment(R.layout.fragment_statistics) {
    ...
    private fun subscribeToObservers() {
        ...
        viewModel.totalAvgSpeedInKMH.observe(viewLifecycleOwner) {
            it?.let {
        ...
        viewModel.runsSortedByDate.observe(viewLifecycleOwner) {
            it?.let {
                ...
                binding.barChart.data = com.github.mikephil.charting.data.BarData(barDataSet)
