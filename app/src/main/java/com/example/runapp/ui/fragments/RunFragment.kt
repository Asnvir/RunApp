...
class RunFragment : Fragment(R.layout.fragment_run), EasyPermissions.PermissionCallbacks {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when (viewModel.sortType) {
            ...
            SortType.DISTANCE_IN_METERS -> binding.spFilter.setSelection(2)
            SortType.AVG_SPEED_IN_KMH -> binding.spFilter.setSelection(3)
        ...
        binding.spFilter.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            override fun onItemSelected(
                ...
                when (position) {
                    ...
                    2 -> viewModel.sortRuns(SortType.DISTANCE_IN_METERS)
                    3 -> viewModel.sortRuns(SortType.AVG_SPEED_IN_KMH)
